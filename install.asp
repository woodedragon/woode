...
div{position:absolute;left: 50%;top: 50%;margin: -250px 0px 0px -300px;padding:0;height:auto;min-height:400px;width:600px;background-color:white;text-align:center;box-shadow:0 0 0.5em rgba(0,0,0,0.2);padding-top:20px;padding-bottom:20px;}
--></style>
</head>
<body>
<div>
<h1>Z-Blog ASP在线安装</h1>
...
If go="GET" Then
%>
<p><%=GetNewVersion()%></p><br/>
<p><img src="http://update.zblogcn.com/zblog2/loading.png" alt="Z-Blog ASP在线安装" title="Z-Blog ASP在线安装"/></p><br/>
...
Function Install1
	...
	Randomize 
	objPing.open "HEAD", "http://update.zblogcn.com/zblog2/Release.xml",False
	...
	For i=-1 To strMax Step 1000000
		...
		objPing.open "GET", "http://update.zblogcn.com/zblog2/Release.xml",False
		objPing.setRequestHeader "User-Agent","Z-BlogInstaller/"&InstallerVersion&"(Host:"&Request.ServerVariables("HTTP_HOST")&") "
