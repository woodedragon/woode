...
<h1>#图片类配置页#</h1>
	...
	<form action="?" method="post" class="am-form">
		            <div class="col-md-12">
					 ...
					 <textarea class="form-control" name="bymgg" rows="1">'.$ini5['bymgg'].'</textarea>
						<br>
					</div>
                    <div class="col-md-4">
						<label for="text">站点名称1</label>
					 <textarea class="form-control" name="zdmc1" rows="1">'.$ini5['zdmc1'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍1</label>
					 <textarea class="form-control" name="zdjs1" rows="1">'.$ini5['zdjs1'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接1</label>
					 <textarea class="form-control" name="zdlj1" rows="1">'.$ini5['zdlj1'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点名称2</label>
					 <textarea class="form-control" name="zdmc2" rows="1">'.$ini5['zdmc2'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍2</label>
					 <textarea class="form-control" name="zdjs2" rows="1">'.$ini5['zdjs2'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接2</label>
					 <textarea class="form-control" name="zdlj2" rows="1">'.$ini5['zdlj2'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点名称3</label>
					 <textarea class="form-control" name="zdmc3" rows="1">'.$ini5['zdmc3'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍3</label>
					 <textarea class="form-control" name="zdjs3" rows="1">'.$ini5['zdjs3'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接3</label>
					 <textarea class="form-control" name="zdlj3" rows="1">'.$ini5['zdlj3'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点名称4</label>
					 <textarea class="form-control" name="zdmc4" rows="1">'.$ini5['zdmc4'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍4</label>
					 <textarea class="form-control" name="zdjs4" rows="1">'.$ini5['zdjs4'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接4</label>
					 <textarea class="form-control" name="zdlj4" rows="1">'.$ini5['zdlj4'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点名称5</label>
					 <textarea class="form-control" name="zdmc5" rows="1">'.$ini5['zdmc5'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍5</label>
					 <textarea class="form-control" name="zdjs5" rows="1">'.$ini5['zdjs5'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接5</label>
					 <textarea class="form-control" name="zdlj5" rows="1">'.$ini5['zdlj5'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点名称6</label>
					 <textarea class="form-control" name="zdmc6" rows="1">'.$ini5['zdmc6'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点介绍6</label>
					 <textarea class="form-control" name="zdjs6" rows="1">'.$ini5['zdjs6'].'</textarea>
						<br>
					</div>
					<div class="col-md-4">
						<label for="text">站点链接6</label>
					 <textarea class="form-control" name="zdlj6" rows="1">'.$ini5['zdlj6'].'</textarea>
						<br>
					</div>
